...
urlpatterns = [
    ...
    path('review/inverter/<int:pk>/history/', views.InverterHistoryView.as_view(), name='history_inverter'),
    ...
    path('review/monitoring/<int:pk>/delete/', views.MonitoringDelete.as_view(), name='delete_monitoring'),
    path('review/monitoring/<int:pk>/history/', views.MonitoringHistoryView.as_view(), name='history_monitoring'),
    ...
    path('review/weather_station/<int:pk>/delete/', views.WeatherStationDelete.as_view(), name='delete_weather_station'),
    path('review/weather_station/<int:pk>/history/', views.WeatherStationHistoryView.as_view(), name='history_weather_station'),
    ...
    path('review/sensor/<int:pk>/delete/', views.SensorDelete.as_view(), name='delete_sensor'),
    path('review/sensor/<int:pk>/history/', views.SensorHistoryView.as_view(), name='history_sensor'),
    ...
    path('review/solarcc/<int:pk>/delete/', views.SolarCCDelete.as_view(), name='delete_solarcc'),
    path('review/solarcc/<int:pk>/history/', views.SolarCCHistoryView.as_view(), name='history_solarcc'),
    ...
    path('review/pv_module/<int:pk>/delete/', views.PVModuleDelete.as_view(), name='delete_pv_module'),
    path('review/pv_module/<int:pk>/history/', views.PVModuleHistoryView.as_view(), name='history_pv_module'),
    ...
    path('review/battery/<int:pk>/delete/', views.BatteryDelete.as_view(), name='delete_battery'),
    path('review/battery/<int:pk>/history/', views.BatteryHistoryView.as_view(), name='history_battery'),
    ...
    path('review/lv_panel/<int:pk>/delete/', views.LVPanelDelete.as_view(), name='delete_lv_panel'),
    path('review/lv_panel/<int:pk>/history/', views.LVPanelHistoryView.as_view(), name='history_lv_panel'),
    ...
    path('review/mv_panel/<int:pk>/delete/', views.MVPanelDelete.as_view(), name='delete_mv_panel'),
    path('review/mv_panel/<int:pk>/history/', views.MVPanelHistoryView.as_view(), name='history_mv_panel'),
    ...
    path('review/trafo/<int:pk>/delete/', views.TrafoDelete.as_view(), name='delete_trafo'),
    path('review/trafo/<int:pk>/history/', views.TrafoHistoryView.as_view(), name='history_trafo'),
    ...
    path('review/all_in_one/<int:pk>/delete/', views.AIODelete.as_view(), name='delete_all_in_one'),
    path('review/all_in_one/<int:pk>/history/', views.AIOHistoryView.as_view(), name='history_all_in_one'),
    ...
    path('review/mounting/<int:pk>/delete/', views.MountingDelete.as_view(), name='delete_mounting'),
    path('review/mounting/<int:pk>/history/', views.MountingHistoryView.as_view(), name='history_mounting'),
