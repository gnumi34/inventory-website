...
urlpatterns = [
    ...
    path('review/monitoring/<int:pk>/history/', views.MonitoringHistory.as_view(), name='history_monitoring'),
    ...
    path('review/weather_station/<int:pk>/history/', views.WeatherStationHistory.as_view(), name='history_weather_station'),
    ...
    path('review/sensor/<int:pk>/history/', views.SensorHistory.as_view(), name='history_sensor'),
    ...
    path('review/solarcc/<int:pk>/history/', views.SolarCCHistory.as_view(), name='history_solarcc'),
    ...
    path('review/pv_module/<int:pk>/history/', views.PVModuleHistory.as_view(), name='history_pv_module'),
    ...
    path('review/battery/<int:pk>/history/', views.BatteryHistory.as_view(), name='history_battery'),
    ...
    path('review/lv_panel/<int:pk>/history/', views.LVPanelHistory.as_view(), name='history_lv_panel'),
    ...
    path('review/mv_panel/<int:pk>/history/', views.MVPanelHistory.as_view(), name='history_mv_panel'),
    ...
    path('review/trafo/<int:pk>/history/', views.TrafoHistory.as_view(), name='history_trafo'),
    ...
    path('review/all_in_one/<int:pk>/history/', views.AIOHistory.as_view(), name='history_all_in_one'),
    ...
    path('review/mounting/<int:pk>/history/', views.MountingHistory.as_view(), name='history_mounting'),
